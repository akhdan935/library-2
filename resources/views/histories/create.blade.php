...
@section('container')
    ...
    <h1 class="h2">Create New History</h1>
    </div>

    <div class="col-lg-12">
        <form method="POST" action="/histories" class="mb-5">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('borrow_until') is-invalid @enderror" id="borrow_until" name="borrow_until" value="{{ old('borrow_until') }}">
                @error('borrow_until')
