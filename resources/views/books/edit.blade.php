...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="POST" action="/books/{{ $book->id }}" class="mb-5" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mb-3">
                <label for="title" class="form-label">Title</label>
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $book->title) }}" autofocus>
                @error('title')
            ...
            <div class="mb-3">
                ...
                <img class="img-preview img-fluid mb-3 col-sm-5 d-block" src="{{ asset('storage/' . $book->cover) }}">
